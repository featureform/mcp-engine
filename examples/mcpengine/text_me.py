...
"""
MCPEngine Text Me Server
--------------------------------
This defines a simple MCPEngine server that sends a text message to a phone number via https://surgemsg.com/.
